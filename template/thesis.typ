...
+ *步骤五：到站激活末端*。运输员抵达中转站后，物流服务触发到站逻辑：物流服务将末端路线状态从-1（待激活）更新为0（待出发）；同时发送末端激活消息，运输员服务消费并创建末端配送单。
...
#tablex(
  [user], [用户表], [3.2.3节],
  [customer], [发货用户信息表], [3.2.4节],
  [address], [地址表], [3.2.4节],
  [shop\_info], [商户信息表], [3.2.5节],
  [product], [承运物表], [3.2.5节],
  [warehouse], [仓库表], [3.2.5节],
  [product\_warehouse], [库存关系表], [3.2.5节],
  [driver\_info], [运输员信息表], [3.2.6节],
  [vehicle], [车辆表], [3.2.6节],
  [order\_info], [订单表], [3.2.7节],
  [delivery], [配送单表], [3.2.7节],
  [hub], [枢纽属性表], [3.2.8节],
  [hub\_link], [运输连接表], [3.2.8节],
  [logistics\_route], [物流路线表], [3.2.8节],
  [logistics\_batch], [配送批次表], [3.2.8节],
  [logistics\_batch\_item], [批次项表], [3.2.8节],
  [dispatch\_pool], [调度池表], [3.2.8节],
  [flow\_plan], [运力规划表], [3.2.8节],
  [flow\_plan\_item], [规划明细表], [3.2.8节],
  header: ([表名], [说明], [正文位置]),
